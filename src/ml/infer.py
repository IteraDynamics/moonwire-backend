...
def infer_score(payload: Dict[str, Any], *, explain: bool = False, top_n: int = 5, models_dir: Path | None = None) -> Dict[str, Any]:
    try:
        ...
        if payload.get("features"):
            ...
            return res
        return {"prob_trigger_next_6h": 0.062, "demo": True, "model_version": _read_model_version()}
    ...
    out = {"prob_trigger_next_6h": proba, "model_version": _read_model_version()}
    if explain:
