...
# --- NEW helper: optional import for governance dashboard builder ---
...
def main() -> None:
    ...
    # --- NEW: build governance dashboard (v0.8.4) before markdown build (best-effort) ---
    build_dashboard = _try_import_dashboard()
    if build_dashboard:
        try:
